...
// File: WinstonAirdropV2.sol

//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.0;

contract WinstonAirdropV2 is Ownable, ReentrancyGuard {
    ...
    function airdropTokens(address token, address[] calldata recipients, uint256[] calldata amounts) external onlyOwner nonReentrant {
        require(recipients.length == amounts.length, "Error: Array lengths do not match");
        require(checkAmounts(token, amounts) == true, "Error: Contract balance not enough to perform operation");
